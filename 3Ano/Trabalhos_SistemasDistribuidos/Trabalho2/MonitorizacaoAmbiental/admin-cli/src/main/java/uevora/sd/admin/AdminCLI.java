...
//Menu Gestao de Dispositivos
    ...
    private static void menuConsultaMetricas() {
        ...
        // Se nao escolheu Sala, tentar Dept
        if (nivel == null) {
        ...
        // Se nao escolheu Dept, tentar Piso
        if (nivel == null) {
        ...
        // Se nao escolheu Piso, tentar Edificio
        if (nivel == null) {
    ...
    //Menu estatistica de Metricas
    private static void menuEstatisticas() {
        try {
            
            // Estatisticas de Dispositivos
            ...
            // Estatisticas de Metricas (Media Global)
